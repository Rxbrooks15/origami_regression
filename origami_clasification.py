...
This research project leverages convolutional neural networks, deep learning, and edge detection to predict origami difficulty (easy, intermediate, and complex). This project would not have been possible without:
